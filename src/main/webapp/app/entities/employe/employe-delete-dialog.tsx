...
export const EmployeDeleteDialog = (props: IEmployeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.employe.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.employe.delete.question" interpolate={{ id: employeEntity.id }}>
