...
import com.mycompany.myapp.service.PresenceService;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Presence}.
 */
@RestController
@RequestMapping("/api")
public class PresenceResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/presences/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<PresenceDTO>> getAllPresences(Pageable pageable) {
