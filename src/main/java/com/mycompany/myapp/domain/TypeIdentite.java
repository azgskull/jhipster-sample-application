...
public class TypeIdentite implements Serializable {
    ...
    public TypeIdentite nom(String nom) {
        this.nom = nom;
        return this;
    }
    ...
    public TypeIdentite description(String description) {
    ...
    public TypeIdentite logo(byte[] logo) {
        this.logo = logo;
        return this;
    }
    ...
    public TypeIdentite logoContentType(String logoContentType) {
