...
class RoleResourceIT {
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().code(DEFAULT_CODE).nom(DEFAULT_NOM).description(DEFAULT_DESCRIPTION);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().code(UPDATED_CODE).nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
        return role;
    }
    ...
    void putNewRole() throws Exception {
        ...
        updatedRole.code(UPDATED_CODE).nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.code(UPDATED_CODE).nom(UPDATED_NOM);
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.code(UPDATED_CODE).nom(UPDATED_NOM).description(UPDATED_DESCRIPTION);
